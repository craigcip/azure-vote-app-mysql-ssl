...
def index():
    ...
    # MySQL Connection
    connection = mysql.connect(user=os.environ['MYSQL_USER'], password=os.environ['MYSQL_PASSWORD'], host=os.environ['MYSQL_HOST'], port=os.environ['MYSQL_PORT'], db=os.environ['MYSQL_DATABASE'] ssl={'ssl': {'ca': os.environ['MYSQL_SSL_CA']}})
